...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      subcommands: false,
      description:
        "Shorten a URL using penfold.fun. Supports custom shortlinks",
    ...
    this.customizeResponse(
      "url",
      "You need to provide a valid URL for me to shorten it, chief!"
    );
  }
  ...
  async init() {
    if (
      ...
      this.client.emit(
        "wtf",
        `Pokole username, password and/or API link not provided, disabling the shorten command.`
      );
      this.disable();
    }
  }
