...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            ...
            requiredSettings: [],
            subcommands: false,
            description: 'Compare the subscriber counts of two YouTube channels and also show the subscriber gap between them',
    ...
    async init() {
        if (!this.client.options.config.youtubeAPI) {
            this.client.emit('wtf', 'YouTube API key not provided in the configuration file, disabling the subgap command.');
            this.disable();
        }
    }
